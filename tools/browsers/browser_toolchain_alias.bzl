...
browser_toolchain_alias = rule(
    doc = """
        Exposes a toolchain alias exposing the template variables for all named
        files included in the browser metadata dependencies. The values of the
        template variables will follow the semantics of Bazel location
        rootpaths.
